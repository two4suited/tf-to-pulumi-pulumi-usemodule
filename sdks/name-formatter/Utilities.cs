...
namespace Pulumi.NameFormatter
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "name-formatter",
                    version: "2026.512.3",
                    value: global::System.Convert.FromBase64String("ewogICJtb2R1bGUiOiAiYXBwLnRlcnJhZm9ybS5pby9CU19JTkMvc3RyaW5nZm9ybWF0dGVyL2Jwcy8vbW9kdWxlcy9uYW1lLWZvcm1hdHRlciIsCiAgInZlcnNpb24iOiAiMjAyNi41MTIuMyIsCiAgInBhY2thZ2VOYW1lIjogIm5hbWUtZm9ybWF0dGVyIgp9")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.NameFormatter.version.txt");
    ...
    internal sealed class NameFormatterResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NameFormatterResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
